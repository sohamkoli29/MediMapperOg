...
<head>
  ...
  <title>AI Medical Expert Chat</title>
<link rel="stylesheet" href="../style/Experts.css">
</head>
<body style="background-image: url('../asset/AyurvedicExpertBg.jpg');">
  <!-- Header -->
    ...
    <div class="header-left">
      ...
      <div class="doctor-profile">
        <div class="doctor-avatar">
          <img src="../asset/aiAyurvedicExpert.jpg" alt="AI Medical Expert">
        </div>
  ...
  <div class="chat-container" id="chatContainer">
    <div class="welcome-message">
      <h3>AI Ayurvedic Expert</h3>
      <p>Hello! I'm your AI Ayurvedic Expert assistant. How can I help you today?</p>
  ...
  <div class="bottom-nav">
    ...
    <a href="AyurvedicExpert.php" class="nav-item active">
      <i>🌿</i>
      <span>Ayurvedic</span>
    </a>
  ...
  <script src="../scripts/AyurvedicExpert.js"></script>
</body>
</html>
