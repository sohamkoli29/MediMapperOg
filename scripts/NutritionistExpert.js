...
async function sendMessage() {
  ...
  try {
    ...
    const prompt = `Suppose you are a Nutritionist/Dietitian Expert and chatting with me as I'm your patient. Keep this in your chat history memory: ${JSON.stringify(
      chatHistory
